...
const Footer = () => {
  return (
    ...
    <footer class="text-gray-400 w-full bg-gray-900 bottom-0 body-font sm:fixed">
        {/* <div class="container px-5 py-24 mx-auto">
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <p class="text-gray-500 text-sm mt-2 md:text-left text-center">Bitters chicharrones fanny pack</p>
            </div>
            </div>
        </div> */}
